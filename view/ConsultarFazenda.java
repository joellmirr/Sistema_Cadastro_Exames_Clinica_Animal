 ...
 * @author joelmir
 */
public class ConsultarFazenda extends javax.swing.JInternalFrame {
    FazendaDao Fdao = new FazendaDao() {};
    /**
     * Creates new form Consultar
     */
    public ConsultarFazenda() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable_Fazenda = new javax.swing.JTable();
        jButton_LimparTabela_ = new javax.swing.JButton();

        setClosable(true);
        setMaximizable(true);
        setTitle("Consulta Fazenda");

        jButton_BuscarVeterinario_.setText("Buscar Fazenda");
        ...
        jButton_BuscaCompleta_.setText("Busca Todos Fazendas");
        ...
        jTable_Fazenda.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTable_Fazenda);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(39, 39, 39)
                .addComponent(jButton_BuscarVeterinario_, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(81, 81, 81)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton_BuscarVeterinario_, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton_BuscarVeterinario_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_BuscarVeterinario_ActionPerformed
        ...
        String sql = "SELECT * FROM Fazenda WHERE car = ?";
        this.BuscarTab(sql);
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Fazenda.getModel();
    ...
    public void BuscarTab(String sql){
        ...
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Fazenda.getModel();
           ...
           // Conectar ao banco de dados e obter dados da tabela
            String SQL = JOptionPane.showInputDialog("Digite Cadastro Anbiental Rural(CAR):");
            try {
                //JOptionPane.showMessageDialog(null,sql);
                PreparedStatement ps = conn.getConexao().prepareStatement(sql);
                ps.setString(1, SQL);
    ...
    public void Atualizar(){
        ...
        int i = jTable_Fazenda.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        FazendaM f = new FazendaM();
        f.setId(jTable_Fazenda.getModel().getValueAt(i,0).toString());
        f.setNome(jTable_Fazenda.getModel().getValueAt(i,1).toString());
        f.setProprietario(jTable_Fazenda.getModel().getValueAt(i,2).toString());
        f.setCAR(jTable_Fazenda.getModel().getValueAt(i,3).toString());
        f.setEmail(jTable_Fazenda.getModel().getValueAt(i,4).toString());
        f.setTelefone(jTable_Fazenda.getModel().getValueAt(i,5).toString());
        f.setEndereco(jTable_Fazenda.getModel().getValueAt(i,6).toString());
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Fazenda.getValueAt(i, 0);
        Fdao.excluir(o);
    ...
    private javax.swing.JTable jTable_Fazenda;

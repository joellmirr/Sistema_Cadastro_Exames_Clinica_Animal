...
public class ConsultarVeterinario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable_Veterinario = new javax.swing.JTable();
        jButton_LimparTabela_ = new javax.swing.JButton();

        setClosable(true);
        setMaximizable(true);
        setTitle("Consulta Veterinario");
        ...
        jButton_BuscaCompleta_.setText("Busca Todos Veterinario");
        ...
        jTable_Veterinario.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTable_Veterinario);
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Veterinario.getModel();
    ...
    public void Atualizar(){
        ...
        int i = jTable_Veterinario.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        VeterinarioM v = new VeterinarioM();
        v.setId(jTable_Veterinario.getModel().getValueAt(i,0).toString());
        v.setNome(jTable_Veterinario.getModel().getValueAt(i,1).toString());
        v.setCrm(jTable_Veterinario.getModel().getValueAt(i,2).toString());
        v.setCpf(jTable_Veterinario.getModel().getValueAt(i,3).toString());
        v.setEspecialidade(jTable_Veterinario.getModel().getValueAt(i,4).toString());
        v.setEmail(jTable_Veterinario.getModel().getValueAt(i,5).toString());
        v.setTelefone(jTable_Veterinario.getModel().getValueAt(i,6).toString());
        v.setEndereco(jTable_Veterinario.getModel().getValueAt(i,7).toString());
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Veterinario.getValueAt(i, 0);
        Vdao.excluir(o);
    ...
    private javax.swing.JTable jTable_Veterinario;

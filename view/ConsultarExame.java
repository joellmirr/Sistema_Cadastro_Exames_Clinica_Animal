 ...
 * @author joelmir
 */
public class ConsultarExame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton_BuscarExame_ = new javax.swing.JButton();
        ...
        jTable_Exame = new javax.swing.JTable();
        jButton_LimparTabela_ = new javax.swing.JButton();

        setClosable(true);
        setMaximizable(true);
        setTitle("Consulta Exames");

        jButton_BuscarExame_.setText("Buscar Exame");
        jButton_BuscarExame_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_BuscarExame_ActionPerformed(evt);
            }
        });
        ...
        jButton_BuscaCompleta_.setText("Busca Todos Exames");
        ...
        jTable_Exame.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTable_Exame);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(39, 39, 39)
                .addComponent(jButton_BuscarExame_, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(81, 81, 81)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton_BuscarExame_, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton_BuscarExame_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_BuscarExame_ActionPerformed
       
        String sql = "SELECT * FROM ExamesAnimal WHERE tipoexame = ?";
        this.BuscarTab(sql);
               
    }//GEN-LAST:event_jButton_BuscarExame_ActionPerformed
    ...
    private void jButton_BuscaCompleta_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_BuscaCompleta_ActionPerformed
        // TODO add your handling code here:
        String sql = "SELECT * FROM ExamesAnimal";
        this.GerarTab(sql);
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Exame.getModel();
    ...
    public void BuscarTab(String sql){
        ...
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Exame.getModel();
           ...
           // Conectar ao banco de dados e obter dados da tabela
            String SQL = JOptionPane.showInputDialog("Digite Tipo Exame:");
            try {
                //JOptionPane.showMessageDialog(null,sql);
                PreparedStatement ps = conn.getConexao().prepareStatement(sql);
                ps.setString(1, SQL);
    ...
    public void Atualizar(){
        int i = jTable_Exame.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        ExameM e = new ExameM();
        e.setIdExame(jTable_Exame.getModel().getValueAt(i,0).toString());
        e.setTipoExame(jTable_Exame.getModel().getValueAt(i,1).toString());
        e.setResulExame(jTable_Exame.getModel().getValueAt(i,2).toString());
        e.setVacina(jTable_Exame.getModel().getValueAt(i,3).toString());
        e.setDataVacina(jTable_Exame.getModel().getValueAt(i,4).toString());
        e.setPeso(jTable_Exame.getModel().getValueAt(i,5).toString());
        e.setDataPeso(jTable_Exame.getModel().getValueAt(i,6).toString());
        e.setAnimal((int) jTable_Exame.getModel().getValueAt(i,7));
        e.setVeterinario((int) jTable_Exame.getModel().getValueAt(i,8));
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Exame.getValueAt(i, 0);
        Edao.excluir(o);
    ...
    private javax.swing.JButton jButton_BuscarExame_;
    ...
    private javax.swing.JTable jTable_Exame;
